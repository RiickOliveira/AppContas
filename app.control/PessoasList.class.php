<?php
	...
	class PessoasList extends TPage{
		...
		function __construct(){
			...
			$obj = new PessoasForm;
			$new_button->setAction(new TAction(array($obj,'onEdit')),'Novo Cliente');
			...
			$cidade = new TDataGridColumn('cidade','Cidade','left',140);
		...
		function onReload(){
			...
			//carrega os clientes q satisfazem o criterio
